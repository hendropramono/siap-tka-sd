...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      secondaryFixed: Color(0xffffdf9f),
      ...
      onTertiaryFixedVariant: Color(0xff074b72),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff88681c),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff00395a),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff3d729b),
      ...
      secondaryFixed: Color(0xff88681c),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff6d5000),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff3d729b),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff0c4d74),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff0c4d74),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffe5bd69),
      onSecondaryContainer: Color(0xff110a00),
      tertiary: Color(0xffe6f1ff),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xff95c8f5),
